  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="flex items-center mb-8">
        ...
        <h1 className="text-3xl font-serif font-bold text-[#171717]">Checkout</h1>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        {/* Order Summary */}
        <div className="bg-white rounded-lg p-6 shadow-sm">
          <h2 className="text-xl font-serif font-semibold text-[#171717] mb-6">Order Summary</h2>
              ...
              return (
                <div key={item._id} className="flex items-center space-x-4">
                  ...
                  <div className="flex-1">
                    <h3 className="font-medium text-[#171717]">{item.product.name}</h3>
        ...
        {/* Shipping Form */}
        <div className="bg-white rounded-lg p-6 shadow-sm">
          <h2 className="text-xl font-serif font-semibold text-[#171717] mb-6">Shipping Information</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-[#D5975B] focus:border-transparent outline-none"
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-[#D5975B] text-white py-3 rounded-lg font-medium hover:bg-[#D5975B]/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed mt-6"
            >
